package br.rio.puc.lac.social.analyzer.execution;
...
import br.rio.puc.lac.social.analyzer.execution.job.semantic.classifier.weka.ClassifierSemanticJob;
 ...
 */
public class WekaClassifierSequentialRegionExclusiveAggregationExecution {
  ...
  public static void main(String[] args) throws Exception {
    ...
    jobs.add(new ClassifierSemanticJob());

...
public class StopWords {
  ...
  public final static Set<String> ENGLISH_STOPWORDS;

  static {
    // "very long list" from http://www.ranks.nl/resources/stopwords.html
    ENGLISH_STOPWORDS =
      Collections.unmodifiableSet(new HashSet<String>(Arrays
        .asList(new String[] { "a", "able", "about", "above", "abst",
            ...
            "specified", "specify", "specifying", "state", "states", "still",

	...
	<body>
		...
		<div id="page-wrap">
			...
			<div id="content">
				...
				<h2 class="title-divider">O que anda acontecendo no #dipucrio?</h2>
				<a class="twitter-timeline" href="https://twitter.com/search?q=%23dipucrio" width="800" height="500" data-widget-id="339066470619283457">Tweets about "#dipucrio"</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
	    	...
	    	<div id="sidebar">
	    		<!-- project tags -->
					<h6 class="side-title">#top 10!</h6>
					<ul class="cat-list">
					<%
						Class.forName("com.mysql.jdbc.Driver"); 
						java.sql.Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/dipucriodb","dipucrioweb","123456"); 
						Statement st = con.createStatement(); 
						ResultSet rs = st.executeQuery("select creatorId, count(*) from contents group by creatorId order by Count(*) desc LIMIT 10;"); 
						while(rs.next()) { 
						  String user = rs.getString(1);
						  int counter = rs.getInt(2);
					%>
			    		<li><a href="http://www.twitter.com/<%=user %>" target="_blank" > <%=user %> (<%=counter %>) </a></li>
						<% } %>
			    	</ul>
					<!-- ENDS project tags -->
	    	</div>

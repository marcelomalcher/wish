	...
	<body>
		...
		<div id="nav-wrapper">
			<ul id="nav" class="sf-menu">
				...
				<li class="current-menu-item"><a href="about.jsp">Sobre...</a></li>				
		...
		<div id="page-wrap">
			...
			<div id="content" class="fullwidth">
				...
				<h2 class="title-divider">Sobre o hotsite #dipucrio...</h2>
				<div class="entry-feature-image"><img src="img/about_dipucrio.png" alt="Image"/></div>
	            <p>O objetivo do hotsite <b>#dipucrio</b> é ser um canal para visualizão das impressões (feelings) dos professores, alunos e demais acerca das atividades do Departamento de Informática da PUC-Rio.</p>             
				<p>Se todos postarem nas redes sociais sobre eventos, palestras, aulas, datas e prazos com a hashtag <b>#dipucrio</b>, agrega-se valor ao hotsite e ao próprio departamento que se aproxima das pessoas envolvidas em suas atividades</p>

package br.rio.puc.lac.wish.service.semantic.svmclassifier;
...
import br.rio.puc.lac.wish.service.semantic.svmclassifier.model.AllInstancesInClass;
import br.rio.puc.lac.wish.service.semantic.svmclassifier.model.DocumentToClassify;
import br.rio.puc.lac.wish.service.semantic.svmclassifier.utils.SentenceAnalysis;
 ...
 */
public class SVMClassifierExecution {
  ...
  public static void main(String[] args) throws Exception {
    ...
    logger =
      Logger.getLogger(SVMClassifierExecution.class.getSimpleName() + "_" + s);
    ...
    SentenceAnalysis analysis =
      new SentenceAnalysis(language, stopWordList
        .toArray(new String[stopWordList.size()]));
